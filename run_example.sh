...
python3 src/model_train.py ignore/ir2vec/ ignore/runtimes/ -t ir2vec -l runtime -o ignore/models/runtime_ir2vec_model.pck --predict-train -c ignore/clusters_ir2vec.yaml
